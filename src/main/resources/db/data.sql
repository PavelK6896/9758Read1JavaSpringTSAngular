...
INSERT INTO post.post (post_id, created_date, description, post_name, vote_count, subreddit_id, user_id) VALUES (100, '2021-01-30 11:02:42.572943', null, 'Самый большой процессор в мире — Cerebras CS-1.', null, 100, 100) ON CONFLICT (post_id) DO NOTHING;
INSERT INTO post.post (post_id, created_date, description, post_name, vote_count, subreddit_id, user_id) VALUES (200, '2021-01-30 11:03:32.656813', null, 'Двойной привод hdd - Seagate MACH.2.', null, 100, 100) ON CONFLICT (post_id) DO NOTHING;
INSERT INTO post.post (post_id, created_date, description, post_name, vote_count, subreddit_id, user_id) VALUES (300, '2021-01-30 11:06:47.074138', null, 'Функция в Kotlin.', null, 200, 100) ON CONFLICT (post_id) DO NOTHING;
